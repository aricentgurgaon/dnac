...
def add_update_parser(subparsers, parent_parser):
    '''Define the "update" command line parsing.'''
    parser = subparsers.add_parser(
        'update',
        help='updates the record',
        parents=[parent_parser])

    parser.add_argument(
        'value',
        type=str,
        help='the change to be added')
