...
class SimpleWalletClient(object):
    ...
    def balance(self):
        ...
        try:
            ...
            print(self._address)
            print("\n\n")
            print((yaml.safe_load(result)["data"]))
...
#abhishek
    def getAllData(self):
        #result = self._send_to_restapi("blocks/{}".format(self._address))
        ...
        try:
            ...
            for x in (yaml.safe_load(result)["data"]):
               #print(x['header']['inputs'])
               if (x['header']['inputs'] == [self._address]):
                    #print("\n\n")
...
#    def _wrap_and_send_updates(self,
#                               action,
#                               *values):
